<div id="notice-widget" class="notice-widget">
    <div class='row'>
        ...
        <?php 
        print theme('image_style', array('style_name' => 'leadimage', 'path' => $node->field_leadimage['und'][0]['uri'], 'alt'=>$node->title), array("attributes"=>array("class"=>array("notice-widget__image"))));
        ?>
